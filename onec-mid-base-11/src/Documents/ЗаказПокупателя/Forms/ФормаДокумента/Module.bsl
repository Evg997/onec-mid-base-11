...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Группа = Элементы.Вставить("ГруппаСкидок", Тип("ГруппаФормы"), ЭтотОбъект, Элементы.Страницы);
    ...
    //{{ Зузыкин Е.В. Добавление команды формы. Задача:Обновление конфигурации 23.12.2024
...
Процедура РассчитатьСуммуСтроки(ТекущиеДанные)
	...
	//Код текущей версии конфигурации
    //	КоэффициентСкидки = 1 - ТекущиеДанные.Скидка / 100;
    //	ТекущиеДанные.Сумма = ТекущиеДанные.Цена * ТекущиеДанные.Количество * КоэффициентСкидки;
		
	СуммированнаяСкидка = 1 - (Объект.Дк_Скидка / 100 + ТекущиеДанные.Скидка / 100);
	
	Если СуммированнаяСкидка < 0 Тогда 
		СуммированнаяСкидка = 0;
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = "Значение скидки превышает 100%";
		Сообщение.Сообщить();
	КонецЕсли;

    ТекущиеДанные.Сумма = ТекущиеДанные.Цена * ТекущиеДанные.Количество * СуммированнаяСкидка;
